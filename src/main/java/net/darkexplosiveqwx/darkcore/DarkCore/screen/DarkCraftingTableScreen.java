...
public class DarkCraftingTableScreen extends AbstractContainerScreen<DarkCraftingTableMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Main.MOD_ID,"textures/gui/dark_crafting_table_gui.png");
    private EnergyInfoArea energyInfoArea;
    private FluidTankRenderer renderer;



    public DarkCraftingTableScreen(DarkCraftingTableMenu menu, Inventory inventory, Component component) {
